  ...
  try {
    ...
    const gradingScale = await payload.create({
      ...
      data: {
        ...
        isActive: true,
        gradeMappings: [
          { minScore: 97, maxScore: 100, letterGrade: 'A+', numericGrade: 4.0, isPassing: true, description: 'Exceptional' },
          { minScore: 93, maxScore: 96, letterGrade: 'A', numericGrade: 4.0, isPassing: true, description: 'Excellent' },
          { minScore: 90, maxScore: 92, letterGrade: 'A-', numericGrade: 3.7, isPassing: true, description: 'Very Good' },
          { minScore: 87, maxScore: 89, letterGrade: 'B+', numericGrade: 3.3, isPassing: true, description: 'Good Plus' },
          { minScore: 83, maxScore: 86, letterGrade: 'B', numericGrade: 3.0, isPassing: true, description: 'Good' },
          { minScore: 80, maxScore: 82, letterGrade: 'B-', numericGrade: 2.7, isPassing: true, description: 'Satisfactory Plus' },
          { minScore: 77, maxScore: 79, letterGrade: 'C+', numericGrade: 2.3, isPassing: true, description: 'Satisfactory' },
          { minScore: 73, maxScore: 76, letterGrade: 'C', numericGrade: 2.0, isPassing: true, description: 'Average' },
          { minScore: 70, maxScore: 72, letterGrade: 'C-', numericGrade: 1.7, isPassing: true, description: 'Below Average' },
          { minScore: 67, maxScore: 69, letterGrade: 'D+', numericGrade: 1.3, isPassing: true, description: 'Poor Plus' },
          { minScore: 63, maxScore: 66, letterGrade: 'D', numericGrade: 1.0, isPassing: true, description: 'Poor' },
          { minScore: 60, maxScore: 62, letterGrade: 'D-', numericGrade: 0.7, isPassing: true, description: 'Minimal Pass' },
          { minScore: 0, maxScore: 59, letterGrade: 'F', numericGrade: 0.0, isPassing: false, description: 'Fail' }
        ]
      }
    })
    ...
    const department = await payload.create({
      ...
      data: {
        ...
        code: 'SE',
        description: 'Department focused on software engineering and development',
        contactInfo: {
    ...
    const program = await payload.create({
      ...
      data: {
        ...
        curriculumRules: {
          ...
          prerequisiteRules: 'Prerequisites must be completed before advanced courses'
        },
        isActive: true
      }
    })
    ...
    const introProgrammingMidterm = await payload.create({
      ...
      data: {
        ...
        isActive: true,
        rubric: [
          { criteria: 'Code Correctness', description: 'Program runs without errors', maxPoints: 40 },
          { criteria: 'Code Quality', description: 'Clean, readable code', maxPoints: 30 },
          { criteria: 'Problem Solving', description: 'Logical approach to problems', maxPoints: 30 }
        ]
      }
    })
    ...
    const introProgrammingProject = await payload.create({
      ...
      data: {
        ...
        instructions: 'Create a complete program demonstrating course concepts.',
        isActive: true
      }
    })
    ...
    const dataStructuresAssignment = await payload.create({
      ...
      data: {
        ...
        instructions: 'Analyze the time and space complexity of given algorithms.',
        isActive: true
      }
    })
    ...
    const introMidtermAssessment = await payload.create({
      ...
      data: {
        ...
        instructions: 'Complete all programming problems. Show your work clearly.',
    ...
    const introFinalAssessment = await payload.create({
      ...
      data: {
        ...
        instructions: 'Complete all sections. Partial credit will be given for correct approaches.',
    ...
    const introProjectAssessment = await payload.create({
      ...
      data: {
        ...
        description: 'Individual programming project demonstrating course concepts',
        ...
        instructions: 'Create a complete program that demonstrates your understanding of programming concepts.',
    ...
    const dataStructuresMidtermAssessment = await payload.create({
      ...
      data: {
        ...
        instructions: 'Analyze algorithms and implement data structures as requested.',
    ...
    await payload.create({
      ...
      data: {
        ...
        feedback: 'Good understanding of basic concepts. Work on code organization.',
    ...
    await payload.create({
      ...
      data: {
        ...
        feedback: 'Excellent project! Well-documented code and creative solution.',
    ...
    await payload.create({
      ...
      data: {
        ...
        feedback: 'Outstanding work! Excellent algorithmic thinking and implementation.',
    ...
    const alexGradeAggregate = await payload.create({
      ...
      data: {
        ...
        decisionNotes: 'Weighted average of midterm (30%), project (30%), and final (40%)',
