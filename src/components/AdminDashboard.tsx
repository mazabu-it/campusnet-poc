...
export function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<
    'overview' | 'universities' | 'faculties' | 'departments' | 'programs' | 'users'
  >('overview')
  ...
  const fetchAdminData = async () => {
    try {
      const [universitiesRes, facultiesRes, departmentsRes, programsRes, usersRes] =
        await Promise.all([
      ...
      const [universitiesData, facultiesData, departmentsData, programsData, usersData] =
        await Promise.all([
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">Faculties</CardTitle>
              </CardHeader>
              <CardContent>
      ...
      {activeTab === 'universities' && (
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-semibold text-gray-900">Universities</h2>
            <Button
              onClick={() => {
                /* Create university */
              }}
